...
function _execute_dsg_model(formul, n = 32, visualize = false)
...
function test_dsg3if(n = 32, visualize = false)
    return _execute_dsg_model(FEMMShellDSG3IFModule, n, visualize)
end

function test_dsg3i(n = 32, visualize = false)
  return _execute_dsg_model(FEMMShellDSG3IModule, n, visualize)
end

function test_dsg3(n = 32, visualize = false)
  return _execute_dsg_model(FEMMShellDSG3Module, n, visualize)
end

function test_q4sri(n = 32, visualize = false)
    # analytical solution for the vertical deflection and the midpoint of the
    # free edge 
    # Parameters:
    E = 2.0e11;
