...
function test_t3(n = 1, LW_ratio = 2.0, visualize = true)
    E = 1e7;
    nu = 0.25;
    W = 1.0;
    L = LW_ratio * W
...
function test_dsg3i(n = 16, LW_ratio = 10.0, visualize = true)
    E = 1e7;
    nu = 0.25;
    W = 1.0;
    L = LW_ratio * W
...
# ribbon_twist_examples.test_dsg3i()
ribbon_twist_examples.test_t6()
