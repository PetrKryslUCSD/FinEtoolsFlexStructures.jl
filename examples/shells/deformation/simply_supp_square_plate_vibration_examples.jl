...
mode shapes. The in-plane modes (5,6,7) are not included.
"""
module simply_supp_square_plate_vibration_examples
...
using .simply_supp_square_plate_vibration_examples
simply_supp_square_plate_vibration_examples.allrun()