...
function test_t3ff(visualize = true)
    ...
    if visualize
        ...
        vtkwrite("sacco_comp_pl_t3ff-m.vtu", fens, fes; scalars = scalars, vectors = [("u", dchi.values[:, 1:3])])
        scalars = []
        for nc in 1:3
        ...
        vtkwrite("sacco_comp_pl_t3ff-n.vtu", fens, fes; scalars = scalars, vectors = [("u", dchi.values[:, 1:3])])
        scalars = []
        for nc in 1:2
        ...
        vtkwrite("sacco_comp_pl_t3ff-q.vtu", fens, fes; scalars = scalars, vectors = [("u", dchi.values[:, 1:3])])

    end
    true
end

function test_q4rs(visualize = true)
    ...
    if visualize
        ...
        vtkwrite("sacco_comp_pl_q4rs-m.vtu", fens, fes; scalars = scalars, vectors = [("u", dchi.values[:, 1:3])])
        scalars = []
        for nc in 1:3
            fld = fieldfromintegpoints(femm, geom0, dchi, :membrane, nc, outputcsys = layup.csys)
            push!(scalars, ("n$nc", fld.values))
        ...
        vtkwrite("sacco_comp_pl_q4rs-n.vtu", fens, fes; scalars = scalars, vectors = [("u", dchi.values[:, 1:3])])
        scalars = []
        for nc in 1:2
            fld = fieldfromintegpoints(femm, geom0, dchi, :shear, nc, outputcsys = layup.csys)
            push!(scalars, ("q$nc", fld.values))
        ...
        vtkwrite("sacco_comp_pl_q4rs-q.vtu", fens, fes; scalars = scalars, vectors = [("u", dchi.values[:, 1:3])])
