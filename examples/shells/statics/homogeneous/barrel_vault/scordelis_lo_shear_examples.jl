...
The goal here is to investigate dependence on the stabilization of the shear stiffness.
"""
module scordelis_lo_shear_examples
...
function _execute_t3ff_model(n = 8, beta = 0.1, visualize = true)
    # Parameters:
    E=4.32e8;
    nu=0.0;
...
function _execute_Q4RS_model(n = 8, beta = 0.1, visualize = true)
    # Parameters:
    E=4.32e8;
    nu=0.0;
    thickness = 0.25; # geometrical dimensions are in feet
