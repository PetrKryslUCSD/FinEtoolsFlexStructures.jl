...
function _execute_t3ff(tL_ratio = 1/100, g = 80*0.1^0, analyt_sol=-9.3355e-5, n = 32, visualize = false)
...
function test_convergence()
    ...
    for (tL_ratio, g, analyt_sol) in zip(tL_ratios, gs, analyt_sols)
        @info "Clamped hypar, t/L=$(tL_ratio), T3FF elements"
        results = Float64[]
        for n in [4, 8, 16, 32, 64, ]
        # for n in [4, 8, 16, 32, 64, ]
            r = _execute_t3ff(tL_ratio, g, analyt_sol, n, false)
