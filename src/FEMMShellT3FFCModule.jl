...
"""
    FEMMShellT3FFC{S<:AbstractFESet, F<:Function} <: AbstractFEMM
...
"""
mutable struct FEMMShellT3FFC{S<:AbstractFESet, F<:Function, M} <: AbstractFEMM
...
function FEMMShellT3FFC(integdomain::IntegDomain{S, F}, mcsys::CSys, material::M) where {S<:AbstractFESet, F<:Function, M}
    _nnmax = 0
    ...
    return FEMMShellT3FFC(integdomain, mcsys, 
...
function FEMMShellT3FFC(integdomain::IntegDomain{S, F}, material::M) where {S<:AbstractFESet, F<:Function, M}
    return FEMMShellT3FFC(integdomain, CSys(3, 3, isoparametric!), material)
end

function make(integdomain, material)
    return FEMMShellT3FFC(integdomain, material)
end

function make(integdomain, mcsys, material)
    return FEMMShellT3FFC(integdomain, mcsys, material)
end
...
function associategeometry!(self::FEMMShellT3FFC,  geom::NodalField{FFlt})
...
function num_normals(self::FEMMShellT3FFC)
    normals, normal_valid = self._normals, self._normal_valid
...
"""
    stiffness(self::FEMMShellT3FFC, assembler::ASS, geom0::NodalField{FFlt}, u1::NodalField{TI}, Rfield1::NodalField{TI}, dchi::NodalField{TI}) where {ASS<:AbstractSysmatAssembler, TI<:Number}

Compute the material stiffness matrix.
"""
function stiffness(self::FEMMShellT3FFC, assembler::ASS, geom0::NodalField{FFlt}, u1::NodalField{TI}, Rfield1::NodalField{TI}, dchi::NodalField{TI}) where {ASS<:AbstractSysmatAssembler, TI<:Number}
...
function stiffness(self::FEMMShellT3FFC, geom0::NodalField{FFlt}, u1::NodalField{TI}, Rfield1::NodalField{TI}, dchi::NodalField{TI}) where {TI<:Number}
...
"""
    mass(self::FEMMShellT3FFC,  assembler::A,  geom::NodalField{FFlt}, dchi::NodalField{TI}) where {A<:AbstractSysmatAssembler, TI<:Number}

Compute the consistent mass matrix

This is a general routine for the shell FEMM.
"""
function mass(self::FEMMShellT3FFC,  assembler::A,  geom0::NodalField{FFlt}, dchi::NodalField{TI}) where {A<:AbstractSysmatAssembler, TI<:Number}
    @assert self._associatedgeometry == true
    fes = self.integdomain.fes
    label = self.integdomain.fes.label
    normals, normal_valid = self._normals, self._normal_valid
...
function mass(self::FEMMShellT3FFC,  geom::NodalField{FFlt},  u::NodalField{TI}) where {TI<:Number}
    assembler = SysmatAssemblerSparseSymm();
...
"""
function inspectintegpoints(self::FEMMShellT3FFC, geom0::NodalField{FFlt},  u::NodalField{TI}, dT::NodalField{FFlt}, felist::FIntVec, inspector::F, idat, quantity=:Cauchy; context...) where {TI<:Number, F<:Function}
    @assert self._associatedgeometry == true
    fes = self.integdomain.fes
    label = self.integdomain.fes.label
    normals, normal_valid = self._normals, self._normal_valid
...
function inspectintegpoints(self::FEMMShellT3FFC, geom::NodalField{FFlt},  u::NodalField{TI}, felist::FIntVec, inspector::F, idat, quantity=:Cauchy; context...) where {TI<:Number, F<:Function}
...
function _resultant_check(self::FEMMShellT3FFC, geom0::NodalField{FFlt}, u1::NodalField{TI}, Rfield1::NodalField{TI}, dchi::NodalField{TI}) where {ASS<:AbstractSysmatAssembler, TI<:Number}
    @assert self._associatedgeometry == true
    fes = self.integdomain.fes
    label = self.integdomain.fes.label
    normals, normal_valid = self._normals, self._normal_valid
