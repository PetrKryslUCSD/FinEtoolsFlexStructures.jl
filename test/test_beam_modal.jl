...
function test()
    ...
    b = 3.0
    h = 30.0
    L = 240.0 # cross-sectional dimensions and length of each leg in millimeters
...
using FinEtoolsFlexStructures.FEMMCorotBeamModule:
    ...
    local_forces!
using FinEtoolsFlexStructures.FEMMCorotBeamModule:
    local_mass_CONSISTENT_WITH_ROTATION_INERTIA!, MASS_TYPE_CONSISTENT_WITH_ROTATION_INERTIA
...
function test()
    ...
    dfes = delegateof(fes)
    A, I1, I2, I3, J, x1x2_vector =
        dfes.A, dfes.I1, dfes.I2, dfes.I3, dfes.J, dfes.x1x2_vector
    G = E / 2 / (1 + nu)
    i = 1
...
using FinEtoolsFlexStructures.FEMMCorotBeamModule:
    ...
    local_forces!
using FinEtoolsFlexStructures.FEMMCorotBeamModule:
    local_mass_CONSISTENT_WITH_ROTATION_INERTIA!,
    MASS_TYPE_CONSISTENT_WITH_ROTATION_INERTIA,
    local_mass_CONSISTENT_NO_ROTATION_INERTIA!,
...
using FinEtoolsFlexStructures.FEMMCorotBeamModule:
    local_mass_CONSISTENT_WITH_ROTATION_INERTIA!,
    MASS_TYPE_CONSISTENT_WITH_ROTATION_INERTIA,
    local_mass_LUMPED_DIAGONAL_NO_ROTATION_INERTIA!,
...
using FinEtoolsFlexStructures.FEMMCorotBeamModule:
    local_mass_CONSISTENT_WITH_ROTATION_INERTIA!,
    MASS_TYPE_CONSISTENT_WITH_ROTATION_INERTIA,
    local_mass_LUMPED_DIAGONAL_WITH_ROTATION_INERTIA!,
    local_mass_original!,
...
for mass_type in [
    FEMMLinBeamModule.MASS_TYPE_CONSISTENT_NO_ROTATION_INERTIA,
